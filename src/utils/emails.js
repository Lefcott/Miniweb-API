...
export const send = (from, to, subject, text, html) =>
  new Promise(async resolve => {
    from = from || `${env.EMAIL_USER} <${env.EMAIL}>`;
    if (!to || !to.length) {
 ...
 * @returns {string[]}
 */
export const getDataErrors = (data, shape = {}, _key = '') => {
  let errors = [];
...
export const getEmail = (template, lang, data) => {
